...
#property  indicator_levelcolor clrAquamarine
#property  indicator_levelwidth 1 
#property  indicator_levelstyle 2

extern ENUM_TIMEFRAMES    TimeFrame   = PERIOD_CURRENT;  // Time frame
extern int                Length      = 13;              // Period
extern ENUM_APPLIED_PRICE Price       = PRICE_CLOSE;    // Price
extern int                NlLength    = 8;             // NonLag smoothing period
...
int OnInit() {
    ...
    SetIndexLabel(5, "");
    SetIndexLabel(6, "");
    SetIndexLabel(7, "Fast1");
    SetIndexLabel(8, "Fast2");
    indicatorFileName = WindowExpertName();
    TimeFrame         = MathMax(TimeFrame,_Period);
    IndicatorShortName(timeFrameToString(TimeFrame)+" FAST Bias ");
